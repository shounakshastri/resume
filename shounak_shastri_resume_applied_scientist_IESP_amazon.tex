...
\section{Summary}
  \justify 
  % \FlushLeft
  Ph.D. with 4 years of experience developing end-to-end scalable Machine Learning solutions for business applications (Computer Vision, Natural Language Processing and Generative AI) that deliver measurable results (23\% improvement in productivity, 81\% reduction in compliance violations). Strong background in Python, statistical modeling and full ML life cycle development--from ideation to monitoring--in a fast-paced environment.  
