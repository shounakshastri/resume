...
\section{Summary}
  \justify
    Ph.D. in Steganography with 4 years of experience in developing POCs and deploying machine learning (ML) models and algorithms for industrial applications. Experienced in handling multiple projects in a dynamic and fast-moving Startup environment. Proven expertise in computer vision, natural language processing, and large language models.  
%-----------EXPERIENCE-----------------
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
      ...
      \textit{\small Technical Analyst (Current)} & \textit{\small Apr. 2025 -- Present} \\
      \textit{\small Sr. Software Engineer (4 years)} & \textit{\small May 2021 -- Mar. 2025} \\
    \end{tabular*}\vspace{-5pt}
      \begin{itemize}[leftmargin=*, itemsep = -2pt]
      \item {Build prototypes and create end-to-end data pipelines to deploy Computer Vision models and GenAI in industrial environments.}
      \item {Design and build ML pipelines for inexperienced staff to work with data and train models in a fast paced and dynamic work environment.}
...
\section{Projects}
  \begin{itemize}[leftmargin=*, itemsep = -2pt]
    ...
    \item {\textbf{Kamerai Productivity Solution:} Owned the development and deployment of the KamerAI Productivity Solution for a major manufacturing client. Collaborated with the client and the KamerAI team to develop productivity and ergonomics dashboards. Trained and deployed ML models across 5 manufacturing stages. Achieved 100\% reduction of errors in 2 stages while improving productivity by ~23\%.}
  \end{itemize}
